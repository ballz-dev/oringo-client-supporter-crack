...
public class ObfuscationServiceMCP implements IObfuscationService {
  ...
  public Set<String> getSupportedOptions() {
    return (Set<String>)ImmutableSet.of("reobfSrgFile", "reobfSrgFiles", "reobfNotchSrgFile", "reobfNotchSrgFiles", "outSrgFile", "outNotchSrgFile", (Object[])new String[] { "outRefMapFile" });
  }
  
  public Collection<ObfuscationTypeDescriptor> getObfuscationTypes() {
    return (Collection<ObfuscationTypeDescriptor>)ImmutableList.of(new ObfuscationTypeDescriptor("searge", "reobfSrgFile", "reobfSrgFiles", "outSrgFile", ObfuscationEnvironmentMCP.class), new ObfuscationTypeDescriptor("notch", "reobfNotchSrgFile", "reobfNotchSrgFiles", "outNotchSrgFile", ObfuscationEnvironmentMCP.class));
  }
}
