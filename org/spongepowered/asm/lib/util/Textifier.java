...
public class Textifier extends Printer {
  ...
  public static void main(String[] paramArrayOfString) throws Exception {
    ...
    if (paramArrayOfString[bool1].endsWith(".class") || paramArrayOfString[bool1].indexOf('\\') > -1 || paramArrayOfString[bool1]
      .indexOf('/') > -1) {
  ...
  public void visit(int paramInt1, int paramInt2, String paramString1, String paramString2, String paramString3, String[] paramArrayOfString) {
    ...
    this.buf.append("// class version ").append(i).append('.').append(j)
      .append(" (").append(paramInt1).append(")\n");
    if ((paramInt2 & 0x20000) != 0)
      this.buf.append("// DEPRECATED\n"); 
    this.buf.append("// access flags 0x")
      .append(Integer.toHexString(paramInt2).toUpperCase()).append('\n');
    ...
    if (paramString2 != null) {
      ...
      this.buf.append("// declaration: ").append(paramString1)
        .append(traceSignatureVisitor.getDeclaration()).append('\n');
    } 
  ...
  public void visitSource(String paramString1, String paramString2) {
    ...
    if (paramString1 != null)
      this.buf.append(this.tab).append("// compiled from: ").append(paramString1)
        .append('\n'); 
    if (paramString2 != null)
      this.buf.append(this.tab).append("// debug info: ").append(paramString2)
        .append('\n'); 
  ...
  public void visitInnerClass(String paramString1, String paramString2, String paramString3, int paramInt) {
    ...
    this.buf.append(
        Integer.toHexString(paramInt & 0xFFFFFFDF).toUpperCase())
      .append('\n');
  ...
  public Textifier visitField(int paramInt, String paramString1, String paramString2, String paramString3, Object paramObject) {
    ...
    this.buf.append(this.tab).append("// access flags 0x")
      .append(Integer.toHexString(paramInt).toUpperCase()).append('\n');
  ...
  public Textifier visitMethod(int paramInt, String paramString1, String paramString2, String paramString3, String[] paramArrayOfString) {
    ...
    if (paramString3 != null) {
      ...
      this.buf.append(this.tab).append("// declaration: ").append(str2)
        .append(' ').append(paramString1).append(str1);
      if (str3 != null)
  ...
  public void visitParameter(String paramString, int paramInt) {
    ...
    appendAccess(paramInt);
    this.buf.append(' ').append((paramString == null) ? "<no name>" : paramString)
      .append('\n');
    this.text.add(this.buf.toString());
  }
  ...
  public void visitIntInsn(int paramInt1, int paramInt2) {
    ...
    this.buf.append(this.tab2)
      .append(OPCODES[paramInt1])
      .append(' ')
      .append((paramInt1 == 188) ? TYPES[paramInt2] : 
        Integer.toString(paramInt2)).append('\n');
    this.text.add(this.buf.toString());
  }
  
  public void visitVarInsn(int paramInt1, int paramInt2) {
    this.buf.setLength(0);
    this.buf.append(this.tab2).append(OPCODES[paramInt1]).append(' ').append(paramInt2)
      .append('\n');
    this.text.add(this.buf.toString());
  }
  ...
  public void visitIincInsn(int paramInt1, int paramInt2) {
    this.buf.setLength(0);
    this.buf.append(this.tab2).append("IINC ").append(paramInt1).append(' ')
  ...
  protected void appendHandle(Handle paramHandle) {
    ...
    this.buf.append("// handle kind 0x").append(Integer.toHexString(i))
      .append(" : ");
    boolean bool = false;
    switch (i) {
      case 1:
  ...
  private void appendTypeReference(int paramInt) {
    ...
    switch (typeReference.getSort()) {
      case 0:
        this.buf.append("CLASS_TYPE_PARAMETER ").append(typeReference
            .getTypeParameterIndex());
        break;
      case 1:
        this.buf.append("METHOD_TYPE_PARAMETER ").append(typeReference
            .getTypeParameterIndex());
        break;
      case 16:
      ...
      case 17:
        this.buf.append("CLASS_TYPE_PARAMETER_BOUND ")
          .append(typeReference.getTypeParameterIndex()).append(", ")
      ...
      case 21:
        ...
        break;
      case 22:
        this.buf.append("METHOD_FORMAL_PARAMETER ").append(typeReference
      ...
      case 65:
        ...
        break;
      case 66:
        this.buf.append("EXCEPTION_PARAMETER ").append(typeReference
      ...
      case 71:
        ...
        break;
      case 72:
        this.buf.append("CONSTRUCTOR_INVOCATION_TYPE_ARGUMENT ").append(typeReference
            .getTypeArgumentIndex());
        break;
      case 73:
        this.buf.append("METHOD_INVOCATION_TYPE_ARGUMENT ").append(typeReference
            .getTypeArgumentIndex());
        break;
      case 74:
        this.buf.append("CONSTRUCTOR_REFERENCE_TYPE_ARGUMENT ").append(typeReference
            .getTypeArgumentIndex());
        break;
      case 75:
        this.buf.append("METHOD_REFERENCE_TYPE_ARGUMENT ").append(typeReference
            .getTypeArgumentIndex());
        break;
    } 
  }
