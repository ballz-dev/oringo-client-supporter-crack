...
public class ASMifier extends Printer {
  ...
  public ASMifier visitParameterAnnotation(int paramInt, String paramString, boolean paramBoolean) {
    this.buf.setLength(0);
    this.buf.append("{\n").append("av0 = ").append(this.name)
      .append(".visitParameterAnnotation(").append(paramInt)
      .append(", ");
  ...
  public void visitFrame(int paramInt1, int paramInt2, Object[] paramArrayOfObject1, int paramInt3, Object[] paramArrayOfObject2) {
    ...
    switch (paramInt1) {
      ...
      case 1:
        declareFrameTypes(paramInt2, paramArrayOfObject1);
        this.buf.append(this.name).append(".visitFrame(Opcodes.F_APPEND,")
          .append(paramInt2).append(", new Object[] {");
        appendFrameTypes(paramInt2, paramArrayOfObject1);
        this.buf.append("}, 0, null");
        break;
      case 2:
        this.buf.append(this.name).append(".visitFrame(Opcodes.F_CHOP,")
          .append(paramInt2).append(", null, 0, null");
        break;
      case 3:
  ...
  public void visitInsn(int paramInt) {
    this.buf.setLength(0);
    this.buf.append(this.name).append(".visitInsn(").append(OPCODES[paramInt])
      .append(");\n");
    this.text.add(this.buf.toString());
  }
  ...
  public void visitVarInsn(int paramInt1, int paramInt2) {
    this.buf.setLength(0);
    this.buf.append(this.name).append(".visitVarInsn(").append(OPCODES[paramInt1])
      .append(", ").append(paramInt2).append(");\n");
    this.text.add(this.buf.toString());
  }
  
  public void visitTypeInsn(int paramInt, String paramString) {
    this.buf.setLength(0);
    this.buf.append(this.name).append(".visitTypeInsn(").append(OPCODES[paramInt])
      .append(", ");
    appendConstant(paramString);
    this.buf.append(");\n");
    this.text.add(this.buf.toString());
  ...
  public void visitFieldInsn(int paramInt, String paramString1, String paramString2, String paramString3) {
    this.buf.setLength(0);
    this.buf.append(this.name).append(".visitFieldInsn(")
      .append(OPCODES[paramInt]).append(", ");
    appendConstant(paramString1);
    this.buf.append(", ");
    appendConstant(paramString2);
    this.buf.append(", ");
  ...
  private void doVisitMethodInsn(int paramInt, String paramString1, String paramString2, String paramString3, boolean paramBoolean) {
    this.buf.setLength(0);
    this.buf.append(this.name).append(".visitMethodInsn(")
      .append(OPCODES[paramInt]).append(", ");
    appendConstant(paramString1);
    this.buf.append(", ");
    appendConstant(paramString2);
  ...
  public void visitJumpInsn(int paramInt, Label paramLabel) {
    ...
    this.buf.append(this.name).append(".visitJumpInsn(").append(OPCODES[paramInt])
      .append(", ");
  ...
  public void visitIincInsn(int paramInt1, int paramInt2) {
    this.buf.setLength(0);
    this.buf.append(this.name).append(".visitIincInsn(").append(paramInt1).append(", ")
  ...
  public void visitTableSwitchInsn(int paramInt1, int paramInt2, Label paramLabel, Label... paramVarArgs) {
    ...
    declareLabel(paramLabel);
    this.buf.append(this.name).append(".visitTableSwitchInsn(").append(paramInt1)
      .append(", ").append(paramInt2).append(", ");
    appendLabel(paramLabel);
  ...
  public void visitMaxs(int paramInt1, int paramInt2) {
    this.buf.setLength(0);
    this.buf.append(this.name).append(".visitMaxs(").append(paramInt1).append(", ")
      .append(paramInt2).append(");\n");
    this.text.add(this.buf.toString());
  }
  ...
  static void appendConstant(StringBuffer paramStringBuffer, Object paramObject) {
    if (paramObject == null) {
      ...
      paramStringBuffer.append("Opcodes.").append(HANDLE_TAG[handle.getTag()])
        .append(", \"");
